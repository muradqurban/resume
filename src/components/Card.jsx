...
const Card = ({ imageSrc, title, description, validate, dateData }) => {
  return (
    <div
      className="w-[350px] relative h-full bg-slate-800 rounded-3xl p-px before:absolute before:w-80 before:h-80 before:-left-40
